...
export function exportFile(editor) {
  ...
  divElements.forEach((divElement) => {
    ...
    // Add to this array if you want to preserve text that is wrapped in a div
    const doNotDelete = ["tab-panel", "footnotes", "accordion-content", "front", "back"];
  ...
  // Add overlay inside of flip card widget for front and back 
  let flipCardOverlays = parsedHtml.querySelectorAll(".front, .back");
  flipCardOverlays.forEach((area) => {
