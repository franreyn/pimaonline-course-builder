...
const buttonsToRemove = ["add-dl-btn","add-img-btn", "add-accordion-btn", "add-assignment-btn", "add-vocab-btn", "add-content-body-btn", "add-vocab-card-btn", "add-col-item-btn"];
